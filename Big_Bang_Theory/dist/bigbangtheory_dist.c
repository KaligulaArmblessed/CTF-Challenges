...
#define ROSES_ARE_RED_WIRES_ARE_TOO  _IOWR(IOC_MAGIC, 0, struct req) 
#define BOOMERS_BEWARE               _IOWR(IOC_MAGIC, 1, struct req) 
#define SNIP_HAPPENS                 _IOWR(IOC_MAGIC, 2, struct req) 
#define JAMES_BOMB                   _IOWR(IOC_MAGIC, 3, struct req) 
#define THIS_IS_FINE                 _IOWR(IOC_MAGIC, 4, struct req) 
#define BOMB_VOYAGE                  _IOWR(IOC_MAGIC, 5, struct req) 
...
static int initialize_secret(void) {
    char str0[] = "ZZZZZZZZZZZZZZZZ\x00"; 
    char str1[] = "ZZZZZZZZZZZZZZZZ\x00"; 
    char str2[] = "ZZZZZZZZZZZZZZZZ\x00"; 
    char str3[] = "ZZZZZZZZZZZZZZZZ\x00";
    char str4[] = "ZZZZZZZZZZZZZZZZ\x00";
    char str5[] = "ZZZZZZZZZZZZZZZZ\x00"; 
    char str6[] = "ZZZZZZZZZZZZZZZZ\x00"; 
    char str7[] = "ZZZZZZZZZZZZZZZZ\x00";
    char str8[] = "ZZZZZZZZZZZZZZZZ\x00";
    char str9[] = "ZZZZZZZZZZZZZZZZ\x00";
    char str10[] = "ZZZZZZZZZZZZZZZZ\x00"; 
...
static long ioctl_module(struct file *filp, unsigned int cmd, unsigned long arg) {
    ...
    switch(cmd) {
        case ROSES_ARE_RED_WIRES_ARE_TOO: { 
            ...
            secret = kzalloc(SECRET_SIZE, GFP_KERNEL); 
            memset(secret, 0x23, SECRET_SIZE); 
